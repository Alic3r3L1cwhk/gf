...
// GetAuthMiddleware implements service.IMiddleware.
func (s *sMiddleware) GetAuthMiddleware() interface{} {
	panic("unimplemented")
}
...
// GetAuthMiddleware 返回认证中间件实例
func GetAuthMiddleware() interface{} {
	return nil
}
